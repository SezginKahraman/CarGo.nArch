...
using AutoMapper;
using CarGo.Application.Features.Users.Constants;
using CarGo.Application.Features.Users.Rules;
using CarGo.Application.Services.Repositories;
using Core.Application.Pipelines.Authorization;
using Core.Security.Entities;
using Core.Security.Hashing;
using MediatR;
using static CarGo.Application.Features.Users.Constants.UsersOperationClaims;

namespace CarGo.Application.Features.Users.Commands.Create
{
